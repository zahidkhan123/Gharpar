...
class DataListPages extends Component {
        ...
        if (jobComplaint.order_job_complaint !== undefined) {
          this.setState({
            order_job_complaint: {
              ...
              default_follow_up: [
                {
                  label: jobComplaint.order_job_complaint.tm_follow_up,
                  value: jobComplaint.order_job_complaint.tm_follow_up,
                },
              ],
              default_status: [
                {
  ...
  dataListRender = async (pageNum, order_id) => {
    ...
    let url = servicePath + "/api/v2/order_job_complaints.json?page=" + pageNum;
