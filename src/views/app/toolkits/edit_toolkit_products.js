...
class EditSetting extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      toolkit_product_id: props.match.params.toolkit_id,
  ...
  async componentDidMount() {
    ...
    let productObj = await this.get_product(toolkit_id);
  ...
  update_product = async (event) => {
    const { toolkit_product_id, toolkit_id } = this.state;
  ...
  get_product = async (toolkit_product_id) => {
    let productObj = null;
    const { toolkit_id } = this.state;
    await trackPromise(
      axios({
              ...
              <form onSubmit={this.update_product}>
                ...
                <ModalBody>
                  ...
                  <Input
                    ...
                    type="text"
                    name="toolkit_product[product_sku]"
                  ...
                  <Input
                    className="form-control"
                    type="text"
                    name="toolkit_product[product_title]"
                  ...
                  <Input
                    className="form-control"
                    type="text"
                    name="toolkit_product[unit_of_measure]"
