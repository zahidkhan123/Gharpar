      ...
      >
        ...
        <form onSubmit={(event) => addComplaint(event, jobComplaint.id)}>
          <ModalBody>
            ...
            <Row className="mt-3">
              <Colxx md="12">
                ...
                <Select
                  ...
                  onChange={(event) => setDiscountPrice(event)}
            ...
            <Row className="mt-3">
              ...
              <Colxx md="4">
                ...
                <Select
                    ...
                    name="order_job_complaint[discount_type]"
                    options={[
                        { label: "Percentage", value: "percentage" },
            ...
            <Row className="mt-3">
              <Colxx md="6">
                ...
                <Select
                  ...
                  name="order_job_complaint[csr_follow_up]"
                  options={follow_up}
                />
              </Colxx>
              <Colxx md="6">
            ...
            {orderJobComplaint.default_escalate &&
            orderJobComplaint.default_tm_comment !== "" ? (
              <>
                <Row className="mt-3">
                  <Colxx md="12">
                ...
                <Row className="mt-3">
                  <Colxx md="12">
                    ...
                    <Input
                      ...
                      defaultValue={
                        orderJobComplaint.default_beautician_comment
                      }
                      disabled
                    />
                  </Colxx>
            ...
            <Row className="mt-3">
              <Colxx md="6">
                <CustomInput
                  className="mt-2"
                  type="checkbox"
                  label="Escalate to T&M"
                  defaultChecked={orderJobComplaint.default_escalate}
              ...
              <Colxx md="6">
                <ReactStars
                  count={5}
                  onChange={(event) => ratingChanged(event)}
