...
class Sidebar extends Component {
  ...
  verifyPermission = async (e, menu) => {
    if (menu.action !== undefined || menu.to !== "/") {
      let response = await check_permission(menu.action, menu.to);
      if (response) {
        this.openSubMenu(e, menu);
      }
    } else {
      this.openSubMenu(e, menu);
    }
                    ...
                    return (
                      ...
                      >
                        {item.newWindow ? (
                          ...
                          <NavLink
                            to={self.props.location.pathname}
                            onClick={(e) => this.verifyPermission(e, item)}
                            ...
                            >
                              {sub.newWindow ? (
                                ...
                                <NavLink
                                  to={self.props.location.pathname}
                                  onClick={() =>
                                    check_permission(sub.action, sub.to)
                                  }
                                >
                                  <i className={sub.icon} />{" "}
                                  <IntlMessages id={sub.label} />
