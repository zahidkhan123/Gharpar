...
module.exports = {
  ...
  /* Added by AppsGenii Developers */

  "menu.city": "City",
  "menu.cities": "Cities",
  "menu.list": "Listing",
  "pages.add-new-city-modal-title": "Add New City",
  "pages.edit-city-modal-title": "Edit City",
  "pages.city-name": "City Name",

  "menu.scheduler": "Scheduler",
  "menu.addons": "Add Ons",

  "menu.service-category": "Service Categories",
  "menu.service_categories": "Categories",
  "pages.add-new-service-category-modal-title": "Add New Service Category",
  "pages.edit-service-category-modal-title": "Edit Service Category",
  "pages.service-category-name": "Service Category Name",
  ...
  "menu.technicians": "Technicians",

  "menu.settings": "Settings",

  "pages.add-new-deal": "Add New Deal",
  "pages.edit-deal": "Edit Deal",

  "pages.add-new-service": "Add New Service",
  "pages.edit-service": "Edit Service",
  "pages.service-name": "Service Name",

  "pages.add-new-user": "Add New User",
  "pages.edit-new-user": "Edit User",
  "pages.user-first-name": "First Name",
  "pages.user-last-name": "Last Name",
  "pages.user-phone-number": "Phone",
  "pages.user-cnic-number": "CNIC",
  "pages.user-gender": "Gender",
  "pages.user-skin-type": "Skin Type",
  "pages.age-range": "Age Range",
  "pages.religion": "Religion",

  "pages.gaurantor-details": "Gaurantor Details",
  "pages.gaurantor-details-1": "1st Gaurantor Details",
  "pages.gaurantor-details-2": "2nd Gaurantor Details",
  "pages.spouse-details": "Spouse/Parents Details",

  "pages.user-addresses": "Address Details",
  "pages.address-title": "Title",
  "pages.address-1": "Address 1",
  "pages.address-2": "Address 2",
  "pages.zip-code": "Zip Code",
  "pages.landmark": "Landmark",
  "pages.is_default": "Make it default",
  "pages.area": "Area",
  "pages.city": "City",

  "pages.working-hours": "Working Hours",
  "pages.user-working-day": "Working Day",
  "pages.user-start-time": "Start Time",
  "pages.user-end-time": "End Time",
